        ...
        <header className="sticky top-0 left-0 right-0 z-[60] bg-white/80 dark:bg-black/80 backdrop-blur-xl border-b border-gray-100 dark:border-white/5 px-4 py-3">
            <div className="flex justify-between items-center max-w-md mx-auto">
                <Link to="/" className="flex items-center gap-2 group">
                    <img src="/logo.png" alt="BioNeural" className="w-10 h-auto object-contain logo-blend group-hover:scale-105 transition-transform" />
                    <span className="font-display font-extrabold text-sm text-secondary dark:text-white tracking-tighter">BioNeural</span>
                </Link>
